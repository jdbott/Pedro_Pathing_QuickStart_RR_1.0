...
public class FollowerConstants {
    ...
    private static final double xMovement = 64.11;
    ...
    public static double largeDrivePIDFFeedForward = 0.05;
    ...
    public static double smallDrivePIDFFeedForward = 0.05;

    // Mass of robot in kilograms
    public static double mass = 5.6;
    ...
    public static double centripetalScaling = 0.000005;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    // this is for curves
    public static double forwardZeroPowerAcceleration = -39;//-30.4551;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    // this is for curves
    public static double lateralZeroPowerAcceleration = -55;//-91.51952;
