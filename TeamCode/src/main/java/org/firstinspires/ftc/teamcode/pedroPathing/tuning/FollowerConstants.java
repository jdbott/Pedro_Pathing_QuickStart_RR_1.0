...
public class FollowerConstants {
    ...
    public static double mass = 5.62454539; //10.65942;
    ...
    // this is for curves
    public static double forwardZeroPowerAcceleration = -35.15;
    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    // this is for curves
    public static double lateralZeroPowerAcceleration = -46.675;//-91.51952;
    ...
    // This can be custom set for each Path.
    public static double pathEndTimeoutConstraint = 1.0;
    ...
    private static final double xMovement = 63.055;
    private static final double yMovement = 49.297;
